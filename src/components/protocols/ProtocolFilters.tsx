...
const ProtocolFilters = ({
  ...
  return (
    <div className="bg-gradient-to-br from-[#9b87f5]/10 to-[#FF4081]/10 backdrop-blur-sm rounded-lg p-3 border border-[#9b87f5]/20">
          ...
          <Button
            ...
            className={`h-8 px-3 whitespace-nowrap ${
              selectedDimension === "all" 
                ? "bg-[#9b87f5]/20 hover:bg-[#9b87f5]/30 text-white" 
