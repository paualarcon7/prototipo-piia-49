...
const ProtocolCard = ({ protocol, isLocked = false }: ProtocolCardProps) => {
  ...
  return (
    <>
      <Card 
        key={protocol.id} 
        className={`bg-gradient-to-br from-[#0EA5E9]/20 to-[#FF4081]/20 backdrop-blur-sm border-secondary/20 p-6 space-y-4 hover:shadow-lg hover:shadow-[#FF4081]/10 transition-all duration-300 cursor-pointer relative ${
